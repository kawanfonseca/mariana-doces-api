...
exports.debugRouter.post('/login', debug_controller_1.debugLogin);
exports.debugRouter.get('/environment', debug_controller_1.debugEnvironment);
exports.debugRouter.get('/database', async (req, res) => {
    try {
